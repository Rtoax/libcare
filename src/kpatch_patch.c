...
kpatch_apply_patches(kpatch_process_t *proc)
{
    ...
    /**
        [kpatch_apply_patches:496] object [heap]
        [kpatch_apply_patches:496] object libc-2.28.so
        [kpatch_apply_patches:496] object [anonymous]
        [kpatch_apply_patches:496] object ld-2.28.so
        [kpatch_apply_patches:496] object [stack]
